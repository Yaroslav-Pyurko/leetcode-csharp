...
| 14 | [Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix/) | Easy | String, vertical scan | O(n &middot; m) | O(m) | [src](src/LeetCode/LC0014_LongestCommonPrefix.cs) &middot; [tests](tests/LeetCode.Tests/LC0014_LongestCommonPrefixTests.cs) |
